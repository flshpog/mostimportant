...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .setDescription("Clear a player's income cooldown (host only).")
    ...
    async execute(interaction) {
        ...
        await interaction.reply({ content: `✅ Cleared the income cooldown for ${user}.`, ephemeral: true });
        await logToHost(interaction.client, `🔄 **${interaction.user.tag}** reset the cooldown for **${user.tag}**.`);
    },
};

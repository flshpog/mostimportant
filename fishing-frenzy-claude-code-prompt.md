...
5. When the window closes, post the fish's name and who caught it (or that it got away). Config
   toggle `announce_on_close`, default true.
...
7. `announce_on_close` reveals the fish name after the window shuts.
